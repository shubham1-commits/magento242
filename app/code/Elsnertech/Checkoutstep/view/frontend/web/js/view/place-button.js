define(
    [
        ...
        'Elsnertech_Checkoutstep/js/model/payment/payment-loading',
        'Elsnertech_Checkoutstep/js/action/start-place-order',
        'Elsnertech_Checkoutstep/js/model/amalert',
        ...
        'Elsnertech_Checkoutstep/js/model/address-form-state',
        'Elsnertech_Checkoutstep/js/model/one-step-layout',
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Elsnertech_Checkoutstep/order/place-order',
