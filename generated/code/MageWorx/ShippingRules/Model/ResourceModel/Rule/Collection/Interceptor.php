<?php
namespace MageWorx\ShippingRules\Model\ResourceModel\Rule\Collection;

/**
 * Interceptor class for @see \MageWorx\ShippingRules\Model\ResourceModel\Rule\Collection
 */
class Interceptor extends \MageWorx\ShippingRules\Model\ResourceModel\Rule\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactory $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Framework\Stdlib\DateTime\TimezoneInterface $date, \Magento\Store\Model\StoreManagerInterface $storeManager, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
    ...
    public function setValidationFilter($storeId, $customerGroupId, $now = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setValidationFilter', func_get_args(), $pluginInfo) : parent::setValidationFilter($storeId, $customerGroupId, $now);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addStoreGroupDateFilter');
        return $pluginInfo ? $this->___callPlugins('addStoreGroupDateFilter', func_get_args(), $pluginInfo) : parent::addStoreGroupDateFilter($storeId, $customerGroupId, $now);
    }
    ...
    public function addDateFilter($now)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addDateFilter', func_get_args(), $pluginInfo) : parent::addDateFilter($now);
    }
