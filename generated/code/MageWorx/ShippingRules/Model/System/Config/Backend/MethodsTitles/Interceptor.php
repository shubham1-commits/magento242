<?php
namespace MageWorx\ShippingRules\Model\System\Config\Backend\MethodsTitles;

/**
 * Interceptor class for @see \MageWorx\ShippingRules\Model\System\Config\Backend\MethodsTitles
 */
class Interceptor extends \MageWorx\ShippingRules\Model\System\Config\Backend\MethodsTitles implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\App\Config\ScopeConfigInterface $config, \Magento\Framework\App\Cache\TypeListInterface $cacheTypeList, \MageWorx\ShippingRules\Helper\Data $helper, \Magento\Framework\Math\Random $mathRandom, ?\Magento\Framework\Model\ResourceModel\AbstractResource $resource = null, ?\Magento\Framework\Data\Collection\AbstractDb $resourceCollection = null, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $helper, $mathRandom, $resource, $resourceCollection, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'makeStorableArrayFieldValue');
        return $pluginInfo ? $this->___callPlugins('makeStorableArrayFieldValue', func_get_args(), $pluginInfo) : parent::makeStorableArrayFieldValue($value);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'makeArrayFieldValue');
        return $pluginInfo ? $this->___callPlugins('makeArrayFieldValue', func_get_args(), $pluginInfo) : parent::makeArrayFieldValue($value);
    }
